...
if ($verification_status === 'unverified') {
    echo '<script>
            alert("Your account is not verified. Please verify your account to be able to start a conversation with others.");
...
$(document).ready(function() {
    ...
    function scrollToNewestMessage() {
        ...
        var scrollSpeed = 1000; // Adjust the speed (in milliseconds) as needed
