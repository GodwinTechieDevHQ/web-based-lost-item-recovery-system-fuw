...
<div class="container mt-4">
    ...
    // function to check if the user if verified
...
if ($verification_status === 'unverified') {
    ...
    echo 'You can\'t start conversations when your account is not verified, please verify your account. ';
    echo '<a href="update_profile.php" class="alert-link">Verify</a>';
    echo '</div>';
}
